...
const howItWorks = [
  { step: "Sign Up", description: "Create your free MeetSync account" },
  {
...
export default function Home() {
  return (
    <main className="container mx-auto px-4 py-16">
      <div className="flex flex-col lg:flex-row items-center justify-between gap-12 mb-24">
        <div className="lg:w-1/2">
          ...
          <p className="text-xl text-slate-600 mb-10">
            MeetSync helps you coordinate your calendar. Create events, invite
            others, and set your availability with ease.
          </p>
          <Link href="/dashboard">
      ...
      <div className="mb-24">
        <h2 className="text-3xl font-bold mb-12 text-center text-green-600">
          Key Features
        </h2>
          ...
          {howItWorks.map((step, index) => {
            return (
              <div key={index} className="text-center">
                ...
                <p className="mb-2 text-slate-600">{step.description}</p>
              </div>
            );
          })}
        </div>
